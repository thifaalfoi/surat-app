...
async function GET() {
    const [totalMasuk, totalKeluar, diproses, selesai, perBulan] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COUNT(*)::int AS count FROM surat WHERE jenis = 'MASUK'`),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COUNT(*)::int AS count FROM surat WHERE jenis = 'KELUAR'`),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COUNT(*)::int AS count FROM surat WHERE status = 'DIPROSES'`),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT COUNT(*)::int AS count FROM surat WHERE status = 'SELESAI'`),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
...
function getPool() {
    if (!/*TURBOPACK member replacement*/ __turbopack_context__.g._pgPool) {
        /*TURBOPACK member replacement*/ __turbopack_context__.g._pgPool = createPool();
    }
    return /*TURBOPACK member replacement*/ __turbopack_context__.g._pgPool;
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0d_3mvc._.js.map